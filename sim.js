...
(function (pxsim) {
    function pinByName(name) {
        ...
        pxsim.U.assert(!!p, "missing pin: " + name + "(" + v + ")");
        return p;
    }
...
(function (pxsim) {
    ...
    (function (visuals) {
        ...
        var MetroBoardSvg = /** @class */ (function (_super) {
            ...
            function MetroBoardSvg(props) {
                ...
                for (var _i = 0, _a = props.visualDef.leds || []; _i < _a.length; _i++) {
                    var l = _a[_i];
                    if (l.color == "neopixel") {
                        _this.onBoardNeopixel = new BoardNeopixel(l.x, l.y, l.w || 9);
                        el.appendChild(_this.onBoardNeopixel.getElement());
                    }
                    else {
                ...
                if (props.visualDef.reset) {
                    _this.onBoardReset = new BoardButton(props.visualDef.reset.x, props.visualDef.reset.y);
                }
            ...
            MetroBoardSvg.prototype.updateState = function () {
                ...
                if (state.buffer) {
                    var rgb = state.pixelColor(0);
                    if (rgb) {
                        this.onBoardNeopixel.setColor(rgb);
                    }
                }
            };
        ...
        var BoardButton = /** @class */ (function () {
            function BoardButton(x, y, r) {
                if (r === void 0) { r = 15; }
                this.element = svg.elt("circle", { cx: x, cy: y, r: r, class: "sim-reset-btn" });
                this.element.addEventListener("click", function () { return pxsim.control.reset(); }, false);
            }
            return BoardButton;
        }());
        var BoardLed = /** @class */ (function () {
            ...
            BoardLed.prototype.getElement = function () {
                return this.element;
            };
        ...
        var BoardNeopixel = /** @class */ (function () {
            function BoardNeopixel(x, y, r) {
                this.element = svg.elt("circle", { cx: x, cy: y, r: r });
            }
            BoardNeopixel.prototype.getElement = function () {
                return this.element;
            };
    ...
    (function (visuals) {
        ...
        var NeoPixelCanvas = /** @class */ (function () {
            ...
            NeoPixelCanvas.prototype.update = function (colors) {
                ...
                for (var i = 0; i < colors.length; i++) {
                    var pixel_1 = this.pixels[i];
                    if (!pixel_1) {
                        var cxy = [0, CANVAS_VIEW_PADDING + i * PIXEL_SPACING];
                        pixel_1 = this.pixels[i] = new NeoPixel(cxy);
                        pxsim.svg.hydrate(pixel_1.el, { title: "offset: " + i });
                        this.canvas.appendChild(pixel_1.el);
                    }
                    var color = colors[i];
                    pixel_1.setRgb(color);
                }
        ...
        var NeoPixelView = /** @class */ (function () {
            ...
            NeoPixelView.prototype.init = function (bus, state, svgEl, otherParams) {
                ...
                this.state = state(pxsim.parsePinString(otherParams["pin"]));
